...
// Slack Handler
const slackHandler = new SlackHandler(config.slackEnabled, alertHandler, config.slackToken, config.slackAppToken, config.slackIncidentChannel, config.slackSdLeadsGroupID, config.slackIncidentTimeout, config.slackDMTimeout);
